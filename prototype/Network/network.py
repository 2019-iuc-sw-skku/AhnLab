...
class Firewall:
    ...
    def parse(self, data):
        ...
        firewall_rules.insert(0, ['packets', 'bytes', 'target', 'protocol', 'option', 'in', 'out', 'source', 'destination'])
...
class NetConnect:
    ...
    def parse(self, data):
        ...
        net_info.insert(0, ['Protocol', 'Recv-Q', 'Send-Q', 'Local Address', 'Foreign Address', 'State'])
        return net_info
...
class RouteTable:
    ...
    def parse(self, data):
        ...
        route_info.insert(0, ['Destination', 'Gateway', 'Genmask', 'Flags', 'Metric', 'Ref', 'Use', 'Iface'])
        return route_info
...
class ArpCache:
    ...
    def parse(self, data):
        ...
        arp_info.insert(0, ['Address', 'HWtype', 'HWaddress', 'Flags', 'Iface'])
        return arp_info
